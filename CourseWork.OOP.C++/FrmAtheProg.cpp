...
///// Initializers /////
void FrmAtheProg::initVariables()
{
	this->className = "FrmAtheProg";
...
FrmAtheProg::FrmAtheProg(vector<Frame*>* frames, ProcessData* process_data, map<string, int>* supported_keys)
...
FrmAtheProg::~FrmAtheProg() {}

///// Functions /////
void FrmAtheProg::update()
{
	stringstream ss;
